...
Tabi uses [Tendermint’s coding repo](https://github.com/tendermint/coding)
...
3. If you would like to contribute:
    ...
    8. Please make sure to run `make format` before every commit -
       ...
       There are CI tests built into the Tabi repository
...
Check out our [good first issues](https://github.com/tabilabs/tabi/issues?q=label%3A%22good+first+issue%22).

## <span id="adr">Architecture Decision Records (ADR)</span>

When proposing an architecture decision for Tabi,
please create an [ADR](https://github.com/tabilabs/tabi/blob/main/docs/architecture/README.md)
...
Now `origin` refers to my fork and `upstream` refers to the tabi version.
So I can `git push -u origin master` to update my fork,
and make pull requests to tabi from there.
...
**Note**: tharsis’s Tabi team currently cuts releases on a need to have basis.
